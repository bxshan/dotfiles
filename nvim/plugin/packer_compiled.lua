...
_G.packer_plugins = {
  ...
  ["cinnamon.nvim"] = {
    ...
    loaded = true,
    path = "/Users/box/.local/share/nvim/site/pack/packer/start/cinnamon.nvim",
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/Users/box/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  undotree = {
    loaded = true,
    path = "/Users/box/.local/share/nvim/site/pack/packer/start/undotree",
    url = "https://github.com/mbbill/undotree"
  },
  ["usage-tracker.nvim"] = {
    loaded = true,
    path = "/Users/box/.local/share/nvim/site/pack/packer/start/usage-tracker.nvim",
