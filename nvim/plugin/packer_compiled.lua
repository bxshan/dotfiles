...
_G.packer_plugins = {
  ...
  ["Hypersonic.nvim"] = {
    loaded = true,
    path = "/Users/box/.local/share/nvim/site/pack/packer/start/Hypersonic.nvim",
  ...
  ["modes.nvim"] = {
    ...
    loaded = true,
    path = "/Users/box/.local/share/nvim/site/pack/packer/start/modes.nvim",
  ...
  ["vim-mips"] = {
    loaded = true,
    path = "/Users/box/.local/share/nvim/site/pack/packer/start/vim-mips",
